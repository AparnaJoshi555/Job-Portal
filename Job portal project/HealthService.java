...
public class HealthService implements ActionListener
{
    JFrame f;
...

    {
       ...
       jl2=new JLabel("   Akaaro,Delhi                ");
        ...
        p1.add(jl1);
        p1.add(jl2);
        p1.add(jl3); p1.add(jl4); p1.add(jl5);
        p1.add(ba1);
